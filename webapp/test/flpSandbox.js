		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Project One",
									"targetURL": "#sapbtpprojectone-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpprojectone-display": {
								"semanticObject": "sapbtpprojectone",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.projectone",
									"url": sap.ui.require.toUrl("sap/btp/projectone")
								}
							}
						}
					}
